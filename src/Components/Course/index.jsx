            ...
            <div className={styles.course}>
                ...
                <div className={styles.courseInfo}>
                    <div className={styles.courseText}>
                        ...
                        <p className={styles.text1}>У нас проводится обучение учеников полету на дронах с использованием
                            как симулятора, так и реальных моделей. Также наши ученики получат знания об обслуживании,
                            сборке и ремонте дрона.</p>
